...
const worker = async () => {
    web3.setProvider(new Web3.providers.HttpProvider("http://18.166.60.86:26659"));
    ...
    try {
        ...
        const fromAddressBalance = web3.utils.toBN(balance).clone();
        if (amount.gt(fromAddressBalance)) {
            console.log("余额不足");
        }
